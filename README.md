...
* 时间：2022.08 – 2022.11
* 类型：叙事向独立RPG Demo / 空间设计

---

## 项目概述

本项目以但丁《神曲》中“七宗罪”为原型，将其转译为一套可被体验的空间系统。核心目标在于通过空间机制的设计，使抽象的欲望、伦理与行为过程被具体化，并在体验中完成“转化”的叙事逻辑。

项目将空间视为一种具有约束与引导能力的媒介，通过规则设定，使玩家在行动过程中逐步经历从欲望到净化的过程。
...
以“七宗罪”为基础，将抽象行为拆解为具体的空间规则，每一种行为对应一种空间机制。空间不再仅作为场景存在，而是直接参与行为塑造。

---

### 空间结构组织

整体采用 Chapter / Level 的组织方式：
...
* 监督（Surveillance）
* 暴露（Exposure）
* 路径高差与难度控制（Elevation / Path Difficulty）
...
* 场地参考：里约热内卢 Rocinha 贫民窟
* 特征：高密度、自组织、复杂地形

在此基础上，将宗教叙事结构嵌入现实空间逻辑，使象征性“试炼空间”与真实城市条件发生叠合，从而形成具有张力的空间系统。
